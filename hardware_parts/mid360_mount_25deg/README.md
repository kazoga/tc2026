# MID-360 前下がり25°マウント — 既存MISUMI JTABS対応（前方オフセット50mm）
...
横梁中心から傾斜支持面中心までの水平距離は前方50mmです。
これはセンサ前端の張り出し量ではありません。取付角は25°、支持面中心高さは30mmです。
...
[公式外形図・規格表](https://jp.misumi-ec.com/vona2/detail/110302701240/)を参照。
...
1. センサ底面と既存板の4穴を合わせ、板の裏からM3で固定します。
   ...
   M3×8ではねじの突出量が大きいため、そのまま使用しないでください。締付トルクはメーカー仕様を優先します。
...
**このJTABS板はMID-360のメーカー推奨放熱条件を満たしません。**
