# MID-360 前下がり25°マウント — 既存MISUMI JTABS対応（試作v2）
...
| 印刷部品 | 寸法 |
| --- | --- |
| 外形：横×前後×高さ | 約190 × 48.94 × 41.41mm |
| 中央ベース | 190 × 24 × 8mm |
| 横梁への固定穴 | φ5.5、横ピッチ170mm、2穴、鉛直方向 |
| 既存板への固定穴 | φ5.5、横ピッチ100mm、2穴、傾斜面に垂直 |
| 傾斜面の中心高さ | 横梁上面から30mm |
| 側面上桟の厚さ | 傾斜面に垂直に8mm |
| 中実CAD体積 | 約60.49cm³。実際の樹脂量はスライス条件による |

CAD座標はX=横梁方向、Y=前方、Z=上。X軸回り−25°で、前ほど低い姿勢です。
...
`--mid360-pitch-deg 25`を指定します。センサ高は取付後の光学原点で測定してください。
