...
def footer(canvas, doc):
    ...
    canvas.drawString(30,18,'TC2026 / 非公式要約 / 2026-09-22確認')
...
output=ROOT/'output/pdf/tc2026_reference.pdf';output.parent.mkdir(parents=True,exist_ok=True)
SimpleDocTemplate(str(output),pagesize=A5,rightMargin=30,leftMargin=30,topMargin=25,bottomMargin=35,
                  title='つくばチャレンジ2026 公式情報参照ガイド',author='tc2026 repository').build(flow,onFirstPage=footer,onLaterPages=footer)
print(output)
