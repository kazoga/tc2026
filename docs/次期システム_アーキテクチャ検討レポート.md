...
| `yolo_detector` | `yolo_node`, `yolo_ncnn_node`, `road_blockage_detector` など | 画像認識、道路封鎖検知、カメラ模擬を行う | 必要に応じて継続使用する |
...
flowchart LR
  ...
  CAM --> YOLO
  YOLO -- "/sig_det_imgs<br/>/road_blocked" --> GUI
  YOLO -- "/road_blocked" --> MANAGER
